...
-- 권한주기
GRANT ALL PRIVILEGES ON hr_db.* TO 'hr'@'%';
-- FLUSH PRIVILEGES;

-- select문만 가능하도록 
GRANT SELECT ON hr_db.* TO 'hr'@'%';
FLUSH PRIVILEGES;




CREATE DATABASE  IF NOT EXISTS `hr_db` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `hr_db`;
